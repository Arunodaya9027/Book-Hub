...
import com.glau.bookhub.database.BookDatabase
import com.glau.bookhub.database.BookEntity
import com.glau.bookhub.util.ConnectionManager
...
class DescriptionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (ConnectionManager().checkConnectivity(this@DescriptionActivity)) {
            ...
            val jsonRequest = object: JsonObjectRequest(Request.Method.POST, url, jsonParams, Response.Listener { it ->
                try {
                    ...
                    if (success) {
                        ...
                        Picasso.get().load(bookJsonObject.getString("image"))
                            .error(R.drawable.default_book_img).into(imgBookImage)
